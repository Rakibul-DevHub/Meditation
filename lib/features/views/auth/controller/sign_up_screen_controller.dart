...
class SignUpScreenController extends GetxController {
  ...
  final RxBool registrationSuccess = false.obs;
...
class SignUpScreenController extends GetxController {
  ...
  Future<void> registerUser() async {
    ...
    try {
      ...
      // Log the URL being used
      debugPrint('🚀 Making POST request to: ${AppUrl.registration}');
      debugPrint('📧 Email being registered: ${request.email}');
      ...
      if (response.isSuccess && (response.statusCode == 200 || response.statusCode == 201)) {
        ...
        if (response.jsonResponse != null) {
          ...
          Get.snackbar(
            'Success',
            registrationResponse.message ?? 'Registration successful! Please verify your email.',
            backgroundColor: Colors.green,
            colorText: Colors.white,
            snackPosition: SnackPosition.TOP,
            duration: const Duration(seconds: 3),
