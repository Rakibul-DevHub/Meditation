...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // FIXED: Featured section with shimmer only (no circular progress)
  Widget _buildFeaturedSection() {
    return Obx(() {
      if ((_controller.isLoadingFeatured.value && _controller.featuredTracks.isEmpty) || _controller.isRefreshingFeatured.value) {
  ...
  // FIXED: Sleep section with shimmer only (no circular progress)
  Widget _buildSleepSection() {
    return Obx(() {
      if ((_controller.isLoadingSleep.value && _controller.sleepTonightTracks.isEmpty) || _controller.isRefreshingSleep.value) {
  ...
  Widget _buildPopularSliverList() {
    return Obx(() {
      if ((_controller.isLoadingPopular.value && _controller.popularTracks.isEmpty) || _controller.isRefreshingPopular.value) {
  ...
  // FIXED: Featured shimmer with no circular progress
  ...
  // FIXED: Sleep shimmer with no circular progress
