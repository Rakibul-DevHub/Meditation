...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // Initialize MenuScreenController for Sleep Timer
  ...
  void initState() {
    ...
    // Initialize MenuScreenController
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          // --- Updated Sleep Button with Obx and Logic ---
                          Obx(() {
                            final timerLabel = _menuController.sleepTimer.value;
                            // Consider it "Active" if it's NOT "Off"
                            ...
                            return GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: isActive
                                        ? const Color(0xFF6366F1) // Purple if active
                                        : const Color(0xff364153), // Grey if inactive
                                  ),
                                ),
                                child: Row(
                                  children: [
