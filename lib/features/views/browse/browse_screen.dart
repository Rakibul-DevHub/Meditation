  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: AnimatedBuilder(
        ...
        child: ClipRRect(
          borderRadius: BorderRadius.circular(24), // Highly rounded organic corners
          child: Stack(
            fit: StackFit.expand,
            children: [
              ...
              // ── Legibility Mask (Ensures high visibility on bright assets) ──
              Container(
                decoration: BoxDecoration(
              ...
              // ── Stacked Content Overlay Layout ────────────────────
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    // Translucent Frosted Glass Circle Badge
                    ClipOval(
